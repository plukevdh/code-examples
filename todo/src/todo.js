(function() {
  ...
  Todo = (function() {
    ...
    Todo.prototype.setNotDone = function() {
      this.done = false;
      return this.change();
    };
  ...
  TodoApp = (function() {
    function TodoApp(el) {
      ...
      this.allCheckbox = this.el.find("#toggle-all").first();
      ...
      this.allCheckbox.on("click", this.toggleAll);
    ...
    TodoApp.prototype.toggleAll = function(evt) {
      var target, todo, _i, _len, _ref, _results;
      target = $(evt.currentTarget);
      _ref = this.collection.all();
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        todo = _ref[_i];
        _results.push(target.is(':checked') ? todo.setDone() : todo.setNotDone());
      }
      return _results;
    };
